...
const foods: Food[] = [
  ...
  { id: 38, mm: 'ဖာလူဒါ', jp: 'ファルーダ', price: 600, category: 'drink', popular: true,
    description: 'ミルクにゼリーやタピオカを重ねた、華やかでひんやり甘いミャンマーの人気ドリンク。',
    ...
    secondaryTitle: 'ရေခဲရွေးပါ / 氷を選択', defaultSecondary: 'normal',
    secondaryOptions: [{id:'none',label:'ရေခဲမပါ / なし',price:0},{id:'less',label:'ရေခဲနည်း / 少なめ',price:0},{id:'normal',label:'ပုံမှန် / 普通',price:0}],
    toppings: [{id:'jelly',label:'ကျောက်ကျော / ゼリー',price:50},{id:'ice-cream',label:'ရေခဲမုန့် / アイスクリーム',price:100},{id:'tapioca',label:'သာကူ / タピオカ',price:50}] },
